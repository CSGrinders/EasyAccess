...
contextBridge.exposeInMainWorld('cloudFsApi', {
    ...
    getItemInfo: (cloudType: CloudType, accountId: string, itemPath: string) =>
        ipcRenderer.invoke('cloud-get-item-info', cloudType, accountId, itemPath) as Promise<FileSystemItem>,
